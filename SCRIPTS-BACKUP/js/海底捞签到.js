...
1.登录后抓包 superapp-public.kiwa-tech.com域名下的_haidilao_app_token，填写到hdl_data,多账号用 @ 分割
...
const notify = $.isNode() ? require('./sendNotify') : '';//通知，用于适配青龙
